...
class Correspondencias(models.Model):
    ...
    codigo_real = models.ForeignKey('Especialidades', models.DO_NOTHING, db_column='codigo_real', primary_key=True)
...
class InterinosBolsas(models.Model):
    ...
    codigo_especialidad = models.ForeignKey(Especialidades, models.DO_NOTHING, db_column='codigo_especialidad', primary_key=True)
