...
gf=GestorFicheros()
texto_plantilla=gf.leer_fichero("plantilla_boletin.html")
texto_boletin=texto_plantilla.format(
    TITULO_BOLETIN.format(fecha_hoy),
    gestor_fechas.convertir_fecha_de_iso_a_estandar(fecha_hace_una_semana),
    fecha_hoy,boletin
