...
for i in range(0, total_lineas):
    ...
    if (linea_contiene_patron(re_dni, linea)):
        ...
        lista_campos_para_insertar.anadir("procedimiento", "Adjudicacion 18-09-2015", ListaCampos.ListaCampos.CADENA)
        lista_campos_para_insertar.anadir("fecha_procedimiento", "2015-09-18")
