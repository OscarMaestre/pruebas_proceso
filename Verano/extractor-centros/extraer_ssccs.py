...
for linea in lineas:
    ...
    if (codigo_centro!=utilidades.NO_CONCORDANCIA):
        ...
        nombre_centro=linea[33:pos_comienzo_localidad].strip()
        ...
        sql_insert_sscc+=generar_insert_cp(codigo_centro, nombre_centro, codigo_localidad, "SSCC")
        
utilidades.escribir_texto_en_fichero("insert_ssccs.sql", sql_insert_sscc);