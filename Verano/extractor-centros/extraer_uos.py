...
for linea in lineas:
    ...
    if (codigo_centro!=utilidades.NO_CONCORDANCIA):
        ...
        nombre_centro=linea[13:pos_comienzo_localidad].strip()
        ...
        sql_insert_uo+=generar_insert_cp(codigo_centro, nombre_centro, codigo_localidad, "UO")
        
utilidades.escribir_texto_en_fichero("insert_uos.sql", sql_insert_uo);