...
update gaseosa set cod_centro='9888' where dni='21678154X';
update gaseosa set auxiliar='HACIENDO SUSTITUCION HASTA 24/06/2016' where dni='21678154X';

insert into nombramientos(nif,nombre_completo,fecha_inicio,fecha_fin,procedimiento,especialidad,codigo_centro) values ('21678154X','DURA PEREZ, RUTH','14/10/2015','24/06/2016','Adjudicacion 13-10-2015','0594423','02004252');
