...
update gaseosa set cod_centro='9888' where dni='05924392Y';
update gaseosa set auxiliar='HACIENDO SUSTITUCION HASTA 16/10/2015' where dni='05924392Y';

insert into nombramientos(nif,nombre_completo,fecha_inicio,fecha_fin,procedimiento,especialidad,codigo_centro) values ('05924392Y','CASCADO MONTES, RUBEN','14/10/2015','16/10/2015','Adjudicacion 13-10-2015','0595512','19008101');
