...
plantilla_sql="""
    select distinct r.codigo_centro, r.especialidad, e.descripcion, p.nombre_completo,
            cr.nombre_centro, l.nombre_localidad, l.nombre_provincia
        from resultas as r, especialidades as e, participantes as p,
...
num_fila=0
num_columna=0
cabeceras=["Provincia", "Localidad", "Centro", "Persona"]
