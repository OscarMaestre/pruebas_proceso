...
for i in range(0, total_lineas):
    ...
    if (linea_contiene_patron(re_dni, linea)):
        ...
        if (obtiene_plaza):
            ...
            campos_sql.anadir("auxiliar", "OBTIENE PLAZA", ListaCampos.ListaCampos.CADENA)
        ...
        campos_sql.anadir('fecha_inicio', "2015-09-01", ListaCampos.ListaCampos.CADENA)
        campos_sql.anadir('fecha_fin', "2100-06-30", ListaCampos.ListaCampos.CADENA)
